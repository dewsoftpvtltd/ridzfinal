...
class PushBots
{
	...
	public function unTag() {
		$response = $this->sendRequest( 'PUT' ,'https://api.pushbots.com', '/tag/del' , $this->unTagData);
		return $response;
	}
	/*
	 * Update Tags by Alias
	 */
	public function updateTagByalias() {
		$response = $this->sendRequest( 'PUT' ,'https://api.pushbots.com', '/tag' , $this->updateTagData);
		return $response;
	}
	public function updateTag($alias,$tags, $token) 
	{
		$this->updateTagData['Alias'] = $alias;
		$this->updateTagData['tag'] = $tags;
		$this->updateTagData['token'] = $token;
		$this->updateTagData['platform'] = array("1");
...
*/
	...
	public function UnTagData($platform,$token,$tags) 
	{
		$this->unTagData['platform'] = $platform;
		$this->unTagData['token'] = $token;
		$this->unTagData['tag'] = $tags;
	}
